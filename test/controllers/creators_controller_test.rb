...
class CreatorsControllerTest < ActionController::TestCase
  ...
  test "should create creator" do
    assert_difference('Creator.count') do
      post :create, creator: { creator_name: @creator.creator_name, dataset_id: @creator.dataset_id, identifier: @creator.identifier }
    end
  ...
  test "should update creator" do
    patch :update, id: @creator, creator: { creator_name: @creator.creator_name, dataset_id: @creator.dataset_id, identifier: @creator.identifier }
    assert_redirected_to creator_path(assigns(:creator))
  end
