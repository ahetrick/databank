...
RSpec.describe DatafilesController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested datafile as @datafile" do
      datafile = Datafile.create! valid_attributes
      get :show, {:id => datafile.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested datafile as @datafile" do
      datafile = Datafile.create! valid_attributes
      get :edit, {:id => datafile.to_param}, valid_session
      expect(assigns(:datafile)).to eq(datafile)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Datafile" do
        expect {
          post :create, {:datafile => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved datafile as @datafile" do
        post :create, {:datafile => invalid_attributes}, valid_session
        expect(assigns(:datafile)).to be_a_new(Datafile)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested datafile" do
        datafile = Datafile.create! valid_attributes
        put :update, {:id => datafile.to_param, :datafile => new_attributes}, valid_session
        datafile.reload
      ...
      it "assigns the requested datafile as @datafile" do
        datafile = Datafile.create! valid_attributes
        put :update, {:id => datafile.to_param, :datafile => valid_attributes}, valid_session
        expect(assigns(:datafile)).to eq(datafile)
      end
    ...
    describe "with invalid params" do
      it "assigns the datafile as @datafile" do
        datafile = Datafile.create! valid_attributes
        put :update, {:id => datafile.to_param, :datafile => invalid_attributes}, valid_session
        expect(assigns(:datafile)).to eq(datafile)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested datafile" do
      datafile = Datafile.create! valid_attributes
      expect {
        delete :destroy, {:id => datafile.to_param}, valid_session
      }.to change(Datafile, :count).by(-1)
    end
