Rails.application.routes.draw do
  ...
  # catch unknown routes, but ignore datatables routes, which are generated by an engine.
  match "/*a" => "errors#error404", :constraints => lambda{|req| req.path !~ /datatables/ }, via: [ :get, :post, :patch, :delete ]
