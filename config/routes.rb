Rails.application.routes.draw do
  ...
  get "/recordfiles/:id/filepath", to: 'recordfiles#filepath', defaults: {format: 'json'}
  get "/recordfiles/:id/preview", to: 'recordfiles#preview'
  get "/recordfiles/:id/display", to: 'recordfiles#display'
  get "/recordfiles/:id/downlaod", to: 'recordfiles#download'
