...
set :linked_files, fetch(:linked_files, []).push('config/database.yml', 'config/secrets.yml', 'config/databank.yml', 'config/shibboleth.yml', 'config/sunspot.yml', 'public/robots.txt', 'nginx.conf.erb')
