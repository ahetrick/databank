...
function setTokenExamples(upload_token, token_expiration) {
    ...
    if (rails_env==="development") {
        ...
        $('.curl-to-copy').html("<pre><code>curl -F &quot;binary=@my_datafile.csv&quot; -H &quot;Authorization: Token token=" + upload_token + "&quot; -H &quot;Transfer-Encoding: chunked&quot; -X POST https://databank.library.illinois.edu/api/dataset/" + dataset_key + "/datafile -o output.txt</code></pre>");
