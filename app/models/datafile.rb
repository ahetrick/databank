...
class Datafile < ActiveRecord::Base
  ...
  def microsoft_preview_url
    if self.is_microsoft?
      ...
      return "https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Fdatabank.illinois.edu%2Fdatasets%2F#{dataset.key}%2Fdatafiles%2#{self.web_id}%2Fdisplay"
